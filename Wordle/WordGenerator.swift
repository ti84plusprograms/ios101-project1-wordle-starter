...
class WordGenerator {
  ...
  static let possibleWords = ["ABCDE", "HOWEY", "HELLO", "WORDL", "STARE", "SWORD", "SPACE", "STARS", "STARE", "STRIP", "CROOK", "CLASP", "CROSS", "CRUSH", "CRYST", "APPLE", "ATLAS"]
  static func generateRandomWord() -> String? {
    // START YOUR CODE HERE
      let elem = possibleWords.randomElement()
      print(elem)
    return elem
    // END YOUR CODE HERE
  }
